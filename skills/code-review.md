...
Your job is to find problems and describe fixes. Output goes to `code-reviews/review-2026-03-31.md`.
...
Output to `code-reviews/review-2026-03-31.md`. Use this structure exactly:
